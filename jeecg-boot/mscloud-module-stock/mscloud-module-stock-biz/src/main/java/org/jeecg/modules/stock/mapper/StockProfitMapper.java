...
public interface StockProfitMapper extends BaseMapper<StockProfit> {
    List<StockProfit> selectStockProfit(@Param("code") String code,@Param("year") Integer year,@Param("quarter") Integer quarter);
    List<Map> selectStockProfitMap(@Param("code") String code,@Param("year") Integer year,@Param("quarter") Integer quarter);
