 ...
 */
@Slf4j
public class ClassWithCustomAnnoScaner {
     ...
     */
    public ClassWithCustomAnnoScaner(List<String> packagesToScan, Class<? extends Annotation>... annotationFilter) {
        this.packagesList=packagesToScan;
