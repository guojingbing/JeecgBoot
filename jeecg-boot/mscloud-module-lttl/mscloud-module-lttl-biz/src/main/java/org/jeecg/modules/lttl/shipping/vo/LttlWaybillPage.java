package org.jeecg.modules.lttl.shipping.vo;
...
public class LttlWaybillPage {
	...
	@ExcelCollection(name="运单货物表")
	@Schema(description = "运单货物表")
	private List<LttlWaybillGoods> lttlWaybillGoodsList;
	@ExcelCollection(name="运单费用表")
	@Schema(description = "运单费用表")
	private List<LttlWaybillFee> lttlWaybillFeeList;
