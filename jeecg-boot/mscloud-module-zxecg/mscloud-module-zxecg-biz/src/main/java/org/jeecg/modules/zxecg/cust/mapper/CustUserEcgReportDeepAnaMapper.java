...
public interface CustUserEcgReportDeepAnaMapper extends BaseMapper<CustUserEcgReportDeepAna> {
    List<Map> loadListPaging(Page<Map> pageList, Long loginUserId, Map<String, Object> likeMap, String column, String order);

    List<CustUserEcgReportDeepAna> getListByRepId(List<Long> repIdList);
}
