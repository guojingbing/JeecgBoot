...
public class FlowingSpeechSynthesizerDemo {
    ...
    public FlowingSpeechSynthesizerDemo() {
    ...
    private static FlowingSpeechSynthesizerListener getSynthesizerListener() {
        ...
        try {
            listener = new FlowingSpeechSynthesizerListener() {
                File f=new File("F:\\flowingTts.wav");
    ...
    public void process(List<String> textList) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        textList.add("百草堂与三");
        textList.add("味书屋 鲁迅 \n我家的后面有一个很");
        textList.add("大的园，相传叫作百草园。现在是早已并屋子一起卖");
        textList.add("给朱文公的子孙了，连那最末次的相见也已经");
        textList.add("隔了七八年，其中似乎确凿只有一些野草；但那时却是我的乐园。\n不必说碧绿的菜畦，光滑的石井栏，高大的皂荚树，紫红的桑葚；也不必说鸣蝉在树叶里长吟，肥胖的黄蜂伏在菜花");
        textList.add("上，轻捷的叫天子(云雀)忽然从草间直窜向云霄里去了。\n单是周围的短短的泥墙根一带，就有无限趣味。油蛉在这里低唱，蟋蟀们在这里弹琴。翻开断砖来，有时会遇见蜈蚣；还有斑");
        textList.add("蝥，倘若用手指按住它的脊梁，便会啪的一声，\n从后窍喷出一阵烟雾。何首乌藤和木莲藤缠络着，木莲有莲房一般的果实，何首乌有臃肿的根。有人说，何首乌根是有像人形的，吃了");
        textList.add("便可以成仙，我于是常常拔它起来，牵连不断地拔起来，\n也曾因此弄坏了泥墙，却从来没有见过有一块根像人样! 如果不怕刺，还可以摘到覆盆子，像小珊瑚珠攒成的小球，又酸又甜，");
        textList.add("色味都比桑葚要好得远......");
        FlowingSpeechSynthesizerDemo demo = new FlowingSpeechSynthesizerDemo();
        demo.process(textList);
        demo.shutdown();
    }
}
