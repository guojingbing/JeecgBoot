 ...
 */
@Slf4j
@Component(IagentChatWebSocketSingle.REDIS_TOPIC_NAME)
public class SocketHandler implements JeecgRedisListener {

    @Autowired
    private IagentChatWebSocketSingle webSocket;

    @Override
    public void onMessage(BaseMap map) {
        log.debug("【Redis发布订阅模式】redis Listener: {}，参数：{}", IagentChatWebSocketSingle.REDIS_TOPIC_NAME, map.toString());
